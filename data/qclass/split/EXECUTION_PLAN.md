...
| Priority | Target | Doc |
|----------|--------|-----|
| 1 | Uniform witness gap + Route C-B (G2b) | `lemma_c_analytic.md`, `g2b_peter_notes.md` | **C-A done** `n≤16`; **C-B open** |
| 2 | G2b / Route C-B programme | `g2b_peter_notes.md`, `g2b_layer_cov_latest.md` | **proxy done** (r≈0.62) |
| 3 | G2d literature | `llt_bands.md` §6.3 |
| 4 | Paper v2.2 (Tier B footnotes) | `paper_v22_tier_b_proposed.md` | **done** (`6c8b149` production hygiene) |
