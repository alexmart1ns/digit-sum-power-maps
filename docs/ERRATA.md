...
Four claims in the July 2026 draft were wrong. This file lists what changed and where. The reasoning
...
| §7.5 | caveat added on how much an MAE at the noise floor can prove |
...
| Appendix B | new: the errata, with the reasoning behind each error |
...
Each prints its own verdict and exits 0. Audit 2 takes about half a minute; the others are quick.
