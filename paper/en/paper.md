...
**Figure 2.** Parameter-free Gaussian-sweep prediction (curves) against the Monte-Carlo split of Figure 1 for signature $\{0\}$, $(k,b)=(3,10)$. MAE $= 0.003$ on $4 \le D \le 60$ (image lattice $v \equiv r^k \pmod 9$).
